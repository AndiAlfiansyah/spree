module Spree
  module PermittedAttributes
    ...
    @@address_attributes = [
      ...
      :address1, :address2, :country_id, :state_id, :city_id, :subdistrict_id,
    ...
    @@product_attributes = [
      ...
      :cost_currency, :cost_price, :discount,
    ...
    @@source_attributes = [
      ...
      :gateway_payment_profile_id, :last_digits, :name, :encrypted_data, :tokenization_status, :token_id]
    ...
    @@store_attributes = [:name, :url, :seo_title, :meta_keywords,
                          :meta_description, :default_currency, :mail_from_address, :image]
